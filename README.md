...
- [**TWZRD Agent Intel: Trust scoring for AI agents on Solana**](https://intel.twzrd.xyz) — Verify agent wallet identity and detect anomalous behavior before x402 micropayments. MCP server (streamable-http). Free tools: resolve_agent, score_agent, preflight_check.
...
- [**Class-Specific Explainability for Deep Time Series Classifiers**](https://arxiv.org/pdf/2210.05411.pdf) , (2022) by *Doddaiah, R., Parvatharaju, P., Rundensteiner, E., & Hartvigsen, T.*, [https://github.com/rameshdoddaiah/DEMUX](https://github.com/rameshdoddaiah/DEMUX), ![](https://img.shields.io/github/stars/rameshdoddaiah/DEMUX.svg?style=social)
...
### Classification
- [**Fast, accurate and explainable time series classification through randomization**](https://link.springer.com/article/10.1007/s10618-023-00978-w) (2023) by *Cabello, N., Naghizade, E., Qi, J., & Kulik, L.* [https://github.com/stevcabello/r-STSF](https://github.com/stevcabello/r-STSF), ![](https://img.shields.io/github/stars/stevcabello/r-STSF.svg?style=social)
- [**XEM: An explainable-by-design ensemble method for multivariate time series classification**](https://link.springer.com/article/10.1007/s10618-022-00823-6) (2022) by *Fauvel, K., Fromont, É., Masson, V., Faverdin, P., & Termier, A* [https://github.com/XAIseries/XEM](https://github.com/XAIseries/XEM), ![](https://img.shields.io/github/stars/XAIseries/XEM.svg?style=social)
